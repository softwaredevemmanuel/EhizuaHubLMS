        ...
        <section className="grid grid-cols-2  gap-6 ">
            <div className="row-span-2 col-span-2 lg:p-4 rounded-lg bg-[#486D8E] grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className='p-[2rem] lg:p-[6rem] grid grid-cols-1 lg:gap-1'>
                    ...
                    <button className='bg-white rounded-lg px-1 font-bold  h-[50px] w-[100px] lg:p-0 text-pink-600 lg:w-[50%] lg:h-[70px]'>Create Memo</button>
                </div>

                <img className='object-cover w-full' src={und} alt="" />
            </div>

            <Link className="rounded-xl bg-[#486D8E] grid grid-cols-2 items-center p-6 h-[100px] lg:h-[180px]">
               <img className='h-[30%] lg:h-full object-cover' src={vector7} alt="" />
               <div className='grid grid-cols-1  text-white font-bold text-[7px] lg:text-[30px]'>
                  <p>Leave Request</p>
                  <p>5</p>
               </div>
            </Link>

            <Link className="rounded-xl bg-[#486D8E] grid grid-cols-2 items-center h-[100px] p-6 lg:h-[180px]">
               <img className='h-[30%] lg:h-full object-cover' src={vector3} alt="" />
               <div className='grid grid-cols-1  text-white font-bold text-[7px] lg:text-[30px]'>
                  <p>Number of staff</p>
                  <p>10</p>
               </div>
            ...
            <Link className="rounded-xl bg-[#486D8E] grid grid-cols-2 items-center h-[100px] p-6 lg:h-[180px]">
               <img className='h-[30%] lg:h-full object-cover' src={vector4} alt="" />
               <div className='grid grid-cols-1  text-white font-bold text-[7px] lg:text-[30px]'>
            ...
            <Link className="rounded-xl bg-[#486D8E] grid grid-cols-2 items-center h-[100px] p-6 lg:h-[180px]">
               <img className='h-[30%] lg:h-full object-cover' src={party} alt="" />
               <div className='grid grid-cols-1  text-white font-bold text-[7px] lg:text-[30px]'>
